...
export const metadata: Metadata = {
  title: "Testimonials",
  description: "Hear from parents and guardians who trust The BrightLight Nursery and Primary School."
};

export default function TestimonialsPage() {
  return (
    <>
      <PageHero eyebrow="Testimonials" title="What Parents Say" subtitle="Hear from parents and guardians who trust The BrightLight Nursery and Primary School." image={images.pupils} />
